"""
Automated Pytest for hplc-chromatography-peak-resolver Enrichment Modules.
"""
import sys
...
from enrichment import (
    AutomatedMethodDevelopmentGradientOptimizationEngine,
    SystemSuitabilityTestingSstAutomationEngine,
...
def test_enrichment_suite_execution():
    suite = HplcchromatographypeakresolverEnrichmentSuite()
