...
import pytest
from hplc_resolver.models import FrontierPayload, ExecutionStatus
from hplc_resolver.engine import FrontierDomainEngine
from hplc_resolver.agents import EMGPeakFittingAgent, ChromatographicResolutionAgent, PeakTailingPurityAgent, HPLCCoordinator
from hplc_resolver.cli import main


def test_sub_agents():
    a1 = EMGPeakFittingAgent()
    ...
    a2 = ChromatographicResolutionAgent()
...
def test_coordinator():
    ...
    assert "USP <621> Chromatography Standards" in ans or "specifications" in ans
