"""
Data Models & Telemetry Definitions for HPLC-Resolver: Chromatographic Peak Deconvolution & Purity Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "USP <621> Chromatography Standards"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
